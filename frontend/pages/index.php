...
$heroImage = qii_content($pdo, 'hero_image', 'images/qii-hero.png');
...
$aboutImage = qii_content($pdo, 'about_image', 'images/qii-bag.png');
...
$giftImage = qii_content($pdo, 'gift_image', 'images/qii-gift.png');
...
$dailyImage = qii_content($pdo, 'daily_image', 'images/2.png');
...
<body>
  ...
  <main id="content">
    ...
    <?= $heroButton ?>
      ...
      <div class="hero-image" data-aos="fade-left">
        <div class="hero-circle">
          <img src="<?= htmlspecialchars($heroImage) ?>" alt="<?= htmlspecialchars($heroImageAlt) ?>" data-image-key="hero_image">
        </div>
      </div>
    </section>
    ...
    <section class="about-section">
      <div class="about">
        <div class="about-left" data-aos="fade-right">
          <img src="<?= htmlspecialchars($aboutImage) ?>" alt="<?= htmlspecialchars($aboutImageAlt) ?>" data-image-key="about_image">
        </div>
    ...
    <section class="about-section">
      <div class="about reverse">
        <div class="about-left" data-aos="fade-left">
          <img src="<?= htmlspecialchars($giftImage) ?>" alt="<?= htmlspecialchars($giftImageAlt) ?>" data-image-key="gift_image">
        </div>
    ...
    <section class="about-section">
      <div class="about">
        <div class="about-left" data-aos="fade-right">
          <img src="<?= htmlspecialchars($dailyImage) ?>" alt="<?= htmlspecialchars($dailyImageAlt) ?>" data-image-key="daily_image">
        </div>
