...
$allowed = [
    ...
    'announcement_title','announcement_intro','announcement_quality',
    'announcement_storage','announcement_shipping',
    'announcement_dispatch','announcement_warning','announcement_button',
